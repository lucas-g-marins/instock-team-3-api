function validateWarehouseData(data) {
    ...
    if (typeof data.warehouse_name !== 'string' || data.warehouse_name.trim() === '') {
    ...
    if (typeof data.contact_name !== 'string' || data.contact_name.trim() === '') {
      return false; // Contact name is missing or not a non-empty string
    }
  
    if (typeof data.contact_position !== 'string' || data.contact_position.trim() === '') {
